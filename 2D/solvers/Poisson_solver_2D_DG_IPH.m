%-------------------------------------------------------------------------
% Poisson_solver_2D_DG_IPH receives
...
% Poisson_solver_2D_DG_IPH returns:
% result(array): containing the solution of the discretized problem with
%                   Hybridazable interior penalty method.
% P,E,T: mesh matrices.
...
%-------------------------------------------------------------------------
function [P,E,T,Pb,Tb,Eb,h,result]=Poisson_solver_2D_DG_IPH(geo,data,para)
...
A=A+assemble_matrix_edges_IPH(data.c,P,T,Tb,Tb,Eb,matrixsize1,matrixsize2,para.basis_type,para.basis_type,para);%assemble matrix of the edge contributions for IPH.
