...
A1=para.mu*assemble_matrix_2D(data.mu,P,T,Tbve,Tbve,ndofve,ndofve,para.basis_type_ve,1,0,para.basis_type_ve,1,0,para.order_Gauss);
A2=para.mu*assemble_matrix_2D(data.mu,P,T,Tbve,Tbve,ndofve,ndofve,para.basis_type_ve,0,1,para.basis_type_ve,0,1,para.order_Gauss);
A3=para.mu*assemble_matrix_2D(data.mu,P,T,Tbve,Tbve,ndofve,ndofve,para.basis_type_ve,1,0,para.basis_type_ve,0,1,para.order_Gauss);
...
A5=-para.mu*assemble_matrix_2D(data.mu,P,T,Tbpre,Tbve,ndofve,ndofpre,para.basis_type_pre,0,0,para.basis_type_ve,1,0,para.order_Gauss);
A6=-para.mu*assemble_matrix_2D(data.mu,P,T,Tbpre,Tbve,ndofve,ndofpre,para.basis_type_pre,0,0,para.basis_type_ve,0,1,para.order_Gauss);
%A7=-para.mu*assemble_matrix_2D(data.mu,P,T,Tbve,Tbpre,ndofpre,ndofve,para.basis_type_ve,1,0,para.basis_type_pre,0,0,para.order_Gauss);
%A8=-para.mu*assemble_matrix_2D(data.mu,P,T,Tbve,Tbpre,ndofpre,ndofve,para.basis_type_ve,0,1,para.basis_type_pre,0,0,para.order_Gauss);
Zero=zeros(ndofpre);
