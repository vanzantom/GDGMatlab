...
A5=-assemble_matrix_2D(data.mu,P,T,Tbpre,Tbve,ndofve,ndofpre,para.basis_type_pre,0,0,para.basis_type_ve,1,0,para.order_Gauss);
A6=-assemble_matrix_2D(data.mu,P,T,Tbpre,Tbve,ndofve,ndofpre,para.basis_type_pre,0,0,para.basis_type_ve,0,1,para.order_Gauss);
