function int_value=Gauss_quadrature_1D_trial_test_coupling(coe_fun,Gauss_nodes,Gauss_weights,vertex_Triangle,vertices1,vertices2,basis_type_trial,basis_index_trial,der_x_trial,der_y_trial,basis_type_test,basis_index_test,der_test)
...
for k=1:Gpn %loop on the Gaussian nodes
        ...
        r=r+Gauss_weights(k)*feval(coe_fun,Gauss_nodes(1,k),Gauss_nodes(2,k))*FE_local_basis_2D(Gauss_nodes(1,k),Gauss_nodes(2,k),vertex_Triangle,basis_type_trial,basis_index_trial,der_x_trial,der_y_trial)*FE_local_basis_1D(Gauss_nodes(:,k),vertices1,vertices2,basis_type_test,basis_index_test,der_test);
end
int_value=r;
end