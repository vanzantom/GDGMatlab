function [P,E,T,Pb,Tb,Eb,h,result]=Poisson_solver_2D_DG_IP(h,basis_type,c,f,Dirichlet_fun,order_Gauss,alpha_coef)
...
A=A+assemble_matrix_edges_IP(c,P,T,Tb,Tb,Eb,matrixsize1,matrixsize2,basis_type,basis_type,order_Gauss,alpha_coef);%assemble the matrix of the edge contributions for IP.
%=== Assembly RHS% 
