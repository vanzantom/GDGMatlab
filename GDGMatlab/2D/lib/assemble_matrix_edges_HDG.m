function A=assemble_matrix_edges_HDG(coe_fun,P,T,Pb,Tb_trial,Tb_test,Eb,matrixsize1,matrixsize2,basis_type_trial,basis_type_test,order_Gauss,alpha_coef)
% The function 'assemble_matrix_edges_HDG' computes the edges terms of a
% HDG, see page 32 Soheil's thesis.
% formulation. Check Antonietti's slides for implementation and Soheil's
% thesis for a formulation.(Check also Cockburn since Soheil's
