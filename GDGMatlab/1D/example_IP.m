%% Example script to use the 1D DG Symmetric internal penalty method
clear all;
a=0;% geometry
b=1;
...
alpha=8; %costant for penalization
plt=0;
%=======convergence plot
%Linear
basis_type=101;
...
[u,P,T,Pb,Tb]=Poisson_solver_1DIP(a,b,h,basis_type,c,f,-1,-1,Dirichlet_fun,Neumann_fun,penalty);
...
h=hh(i);
penalty=alpha/h;
[u2order,P,T,Pb,Tb]=Poisson_solver_1DIP(a,b,h,basis_type,c,f,-1,-1,Dirichlet_fun,Neumann_fun,penalty);
